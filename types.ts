...
/**
 * Interface for the generated evolution of a Pokémon.
 */
export interface PokemonEvolution {
  evolutionName: string;
  evolutionDescription: string;
  evolutionStats: string;
  evolutionImageBase64: string; // Base64 encoded image data for the evolution
  generatedAt: string; // ISO 8601 string for when the evolution was generated
}
...
export interface Pokemon {
  ...
  evolution?: PokemonEvolution | null; // Optional evolution field
}
